            ...
            <div class="container-fluid">
                <div class="header-bottom-wrapper">
                    <div class="logo-2 furniture-logo ptb-30">
                        <a href="/">
                            <img src="{{ asset('themes/ezone/assets/img/logo/logoku.png') }}" alt="">
                        </a>
                    </div>
                    <div class="header-cart">
                        <a style="margin-top: 25px;" class="icon-cart-furniture" href="{{ url('carts') }}">
            ...
            <div class="services-wrapper">
                <div class="single-services mb-40">
                    ...
                    <div class="services-content">
                        <h4>Free Shipping</h4>
                        <p>Enjoy free shipping for new customer. </p>
                    </div>
                </div>
                <div class="single-services mb-40">
                    <div class="services-img">
                    ...
                    <div class="services-content">
                        <h4>24/7 Support</h4>
                        <p>We provide customer service for 24 hours a day. </p>
                    </div>
                </div>
                <div class="single-services mb-40">
                    <div class="services-img">
                    ...
                    <div class="services-content">
                        ...
                        <p>All payments you made are guaranteed. </p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="widget-wrapper">
                    <div class="footer-widget mb-30">
                        <a href="#"><img src="{{ asset('themes/ezone/assets/img/logo/logoku.png') }}"
                                alt=""></a>
                        <div class="footer-about-2">
                            <p>Apparance is well known online clothes, accessories, <br>and fashion shop in Indonesia.
                                Majority of our product <br>made in good quality, by proficient tailor.
                            </p>
                        </div>
                    </div>
                    <div class="footer-widget mb-30">
                        ...
                        <div class="footer-info-wrapper-3">
                            <div class="footer-address-furniture">
                                ...
                                <div class="footer-info-content3">
                                    <p>Ciwastra No. 33, Bandung, West Java <br>Indonesia - 40292</p>
                                </div>
                            </div>
                            <div class="footer-address-furniture">
                                <div class="footer-info-icon3">
                                ...
                                <div class="footer-info-content3">
                                    <p>+62 (21) 515609735 <br>+62 (22) 223352333</p>
                                </div>
                            </div>
                            <div class="footer-address-furniture">
                                <div class="footer-info-icon3">
                                ...
                                <div class="footer-info-content3">
                                    <p><a href="#"> apparance@apparance.com</a> <br><a href="#">
                                            apparance@apparance.info</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="copyright-furniture">
                            <p>Copyright © <a href="https://hastech.company/">Apparance</a> 2023 . All Right Reserved.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="quick-view-learg-img">
                            <div class="quick-view-tab-content tab-content">
                                <div class="tab-pane active show fade" id="modal1" role="tabpanel">
                                    <img src="{{ asset('themes/ezone/assets/img/quick-view/l1.jpg') }}"
                                        alt="">
                                </div>
                                <div class="tab-pane fade" id="modal2" role="tabpanel">
                                    <img src="{{ asset('themes/ezone/assets/img/quick-view/l2.jpg') }}"
                                        alt="">
                                </div>
                                <div class="tab-pane fade" id="modal3" role="tabpanel">
                                    <img src="{{ asset('themes/ezone/assets/img/quick-view/l3.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                        </div>
